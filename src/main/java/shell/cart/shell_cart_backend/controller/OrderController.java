...
public class OrderController {
    ...
    @Operation(
            ...
            description = "Returns an order belonging to the logged-in user."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public OrderResponse getOrderById(
        ...
        Order order = orderService.getOrderByIdForUser(
                email,
                id
        );
    ...
    @Operation(
            ...
            description = "Returns all items belonging to an order owned by the logged-in user."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public List<OrderItemResponse> getOrderItems(
        ...
        return orderService.getOrderItemsForUser(
                        email,
                        orderId
                )
                .stream()
